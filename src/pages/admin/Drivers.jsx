...
export default function DriversPage() {
  ...
  return (
    <div className="max-w-4xl">
      <h1 className="admin-h1 mb-5">Choferes y nannies</h1>

      <div className="bg-signal-yellow/20 border border-signal-yellow rounded-lg px-4 py-3 text-sm text-navy-800 mb-5">
        No necesitas crear ninguna contraseña: cada persona entra sola con su cuenta de Google
        institucional. Solo asegúrate de que el correo que registres aquí sea exactamente el mismo
        con el que iniciará sesión.
      </div>
